...
export class Test {
    ...
    startQuiz() {
        ...
        this.interval = setInterval(function () {
            ...
            if (seconds === 0) {
                clearInterval(this.interval);    // Функция для остановки таймера
                this.complete();            // Для таймера контекст this будет меняться на window. Для этого функции прописываем bind(this).
            }
        }.bind(this), 1000);
    }
